...
var renderTemplate = function (blob, argsObject) {
  ...
  <html id="renderTemplate">
    <head>
      <base target="_top">
      <meta charset="UTF-8">
      <meta name="renderTemplate" content="Subscribe Render Template">
  ...
  return tmp
    ...
    .append(schedule)
    .setXFrameOptionsMode(HtmlService.XFrameOptionsMode.ALLOWALL)
    .setTitle("Don'time Life Services - Social Media Subscribe");
};
...
var appList = function (e) {
  ...
  <html id="appList">
    <head>
      <base target="_top">
      <meta charset="utf-8">
      <meta name="appList" content="Subscribe Function List">
      <meta name=viewport content="width=device-width, initial-scale=1">
      <link href="https://fonts.googleapis.com/css?family=Acme" rel="stylesheet">
    </head>
    <body>
              ...
              <div class="black" id="seoData">
                <div class="row">
                  <div class="col s10 l10 m10 card-panel push-s1 push-l1 push-m1">
                    <div class="container row valign-wrapper" style="border: 2px solid powderblue"><?!= foo.rule() ?></div>
